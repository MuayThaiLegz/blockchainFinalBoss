...
import Community from './Items/allnext'
...
class App extends Component {
    constructor(){
	 ...
	 // this.newPostonBoard =  this.newPayment.bind(this);
     // this.PostCofirmCheck = this.PostCofirmCheck.bind(this);
     // this.newPost = this.newPost.bind(this);   
		...
		this.state = {
            ...
            minutes: '11',  // responsible for the minutes
			tflag: true
		};
...
this.intervalBalance = setInterval(this.bCheck,10000);
  ...
  tflag: false
	...
	// let homepage = app.state.homepage;
