...
/// @title A contract that is able to facilitate donations from a few different cc's
...
contract Charitable {
    ...
    modifier validateCharity(uint256 charityIndex) {
        require(charityIndex <= charityAddress.length - 1, 'Invalid charity index.');
        _;
    }
